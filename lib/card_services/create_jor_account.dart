...
class CreateJORAccount extends StatefulWidget {
  const CreateJORAccount({super.key});

  @override
  State<CreateJORAccount> createState() => _CreateJORAccountState();
}

class _CreateJORAccountState extends State<CreateJORAccount> {
