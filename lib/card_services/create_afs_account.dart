...
class CreateAFSAccount extends StatefulWidget {
  const CreateAFSAccount({super.key});

  @override
  State<CreateAFSAccount> createState() => _CreateAFSAccountState();
}

class _CreateAFSAccountState extends State<CreateAFSAccount> {
