...
class ManualOnboarding extends StatefulWidget {
  const ManualOnboarding({super.key});

  @override
  State<ManualOnboarding> createState() => _ManualOnboardingState();
}

class _ManualOnboardingState extends State<ManualOnboarding> {
